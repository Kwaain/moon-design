    ...
    switch (size) {
      ...
      classes += ' after:rounded-full ';
          ...
          classes +=
            ...
            classes +=
              'w-full h-full after:w-1/2 after:h-[40px] after:z-0 peer-checked:after:z-0 after:top-1 after:left-1 after:px-1 after:py-1 after:rounded-[8px] rounded-[12px] p-1 gap-1 ';
          }

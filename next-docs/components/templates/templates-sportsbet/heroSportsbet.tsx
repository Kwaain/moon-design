...
const Hero = ({
  ...
  return (
    <div
      className={`w-full flex flex-col justify-center items-center relative h-[600px] bg-bottom pt-[72px] bg-[#232a33] ${
    ...
    >
      ...
      <div className="text-goten rounded-b-2xl p-5 bg-[#232a33] flex flex-col items-center absolute -bottom-48 -mb-10 z-1 sm:p-0 sm:bg-transparent sm:w-[450px] sm:min-w-[450px] sm:relative sm:top-[209px] sm:bottom-0 sm:mb-0 sm:pb-24 sm:items-start sm:ml-[380px] lg:ml-[160px] xl:w-[576px] xl:ml-[232px]">
        {headline}
        {subtitle}
        {button}
      </div>

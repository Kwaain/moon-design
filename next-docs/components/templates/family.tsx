...
const Family = ({
  ...
  return (<div className="flex flex-col items-center w-full py-[96px] sm:py-0 sm:flex-wrap sm:justify-center sm:flex-row-reverse sm:top-0 md:w-[80%] md:justify-center md:flex-nowrap lg:my-[246px] xl:w-full ">

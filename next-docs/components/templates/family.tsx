...
const Family = ({ title, subtitle, image }: Props) => {
  return (
    <div className="flex flex-col items-center w-full my-[96px] sm:flex-wrap sm:justify-center sm:flex-row-reverse sm:top-0 md:w-[80%] md:justify-center md:flex-nowrap lg:my-[246px] xl:w-full ">

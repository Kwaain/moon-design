...
const ExploreCarouselItem = ({
 items = [],
  ...
  return (<div className="w-full h-full flex pl-2 sm:p-6">
    <div className="w-[140px] me-4 flex flex-col items-stretch lg:w-[272px]">
      <div className="h-16"/>
      <div className="w-[150px] h-[180px] grow-1 mb-1 sm:mb-4 relative rounded-lg lg:w-[272px] lg:h-[316px]">
      ...
      <div className="w-[150px] h-[180px] grow-1 relative rounded-lg lg:w-[272px] lg:h-[316px]">
    ...
    <div className="w-[150px] me-5 flex flex-col items-stretch lg:w-[272px]">
      <div className="w-[150px] h-[180px] grow-1 mb-1 sm:mb-4 relative rounded-lg lg:w-[272px] lg:h-[316px]">

...
import Default from '../../../public/examples/chartsTW/lineChart/Default';
import Loading from '../../../public/examples/chartsTW/lineChart/Loading';
import useExamples from '../../../utils/useExamples';

export default function PageLineChart() {
  const examples = useExamples('chartsTW/lineChart');

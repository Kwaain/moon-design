...
import Active from '../../../public/examples/chartsTW/tableChart/Active';
import Default from '../../../public/examples/chartsTW/tableChart/Default';
import Loading from '../../../public/examples/chartsTW/tableChart/Loading';
import useExamples from '../../../utils/useExamples';

export default function PageLineChart() {
  const examples = useExamples('chartsTW/tableChart');

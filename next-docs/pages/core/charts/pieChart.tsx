...
import Default from '../../../public/examples/chartsTW/pieChart/Default';
import Loading from '../../../public/examples/chartsTW/pieChart/Loading';
import useExamples from '../../../utils/useExamples';

export default function PageLineChart() {
  const examples = useExamples('chartsTW/pieChart');
